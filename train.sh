...
# IMDB
python train_single_gpu.py --dataset imdb --criterion cross_entropy --model classifier   --device mps --mha_type vanilla   --structure 6x512
python train_single_gpu.py --dataset imdb --criterion cross_entropy --model classifier   --device mps --mha_type cosformer --structure 6x512
