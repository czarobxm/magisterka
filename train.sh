...
python3 train_single_gpu.py --task sequence_modelling --dataset enwik8   --criterion cross_entropy --model decoder_only --device mps --mha_type cosformer --act_fun relu --structure 8x512 --batch_size 8 --epochs 12 --lr 0.00002 --tokenizer google/byt5-small --apply_rotary_pos_enc False
python3 train_single_gpu.py --task sequence_modelling --dataset enwik8   --criterion cross_entropy --model decoder_only --device mps --mha_type cosformer --act_fun relu --structure 6x512 --batch_size 8 --epochs 12 --lr 0.00002 --tokenizer google/byt5-small --apply_rotary_pos_enc False
